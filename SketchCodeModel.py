...
class SketchCodeModel():
    ...
    def train(self, training_path, validation_path, epochs):
        ...
        training_generator, train_steps_per_epoch = dataprocessor.create_generator(training_path, max_sequences=MAX_SEQ)
        validation_generator, val_steps_per_epoch = dataprocessor.create_generator(validation_path, max_sequences=MAX_SEQ)
